...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/common/shoppingcart","/static/**", "/", "/test", "/user/userlogin", "/user/userjoin", "/owner/request","/owner/ownerlogin", "/master/masterlogin","/user/storeView","/user/storeGoodsView").permitAll()
